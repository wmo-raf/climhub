# Generated by Django 5.0.9 on 2024-11-18 08:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "category_name",
                    models.CharField(help_text="Category Name", max_length=255),
                ),
                ("color", models.CharField(help_text="Hex code for category color")),
                (
                    "countries",
                    models.CharField(
                        help_text="Select one or multiple countries in Africa, separated by commas"
                    ),
                ),
            ],
            options={
                "verbose_name": "Map Types",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("description", models.TextField(help_text="Description of the map")),
                (
                    "map_categories",
                    models.ManyToManyField(
                        blank=True,
                        help_text="Select one or more categories for this map",
                        to="core.mapcategory",
                    ),
                ),
            ],
